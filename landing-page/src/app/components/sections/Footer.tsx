        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="mb-4">
                Autentyczny japoński ramen przygotowywany z pasją i tradycyjnymi
                metodami. Zapraszamy na kulinarne doświadczenie prosto z serca
                Japonii.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>Poniedziałek - Piątek: 12:00 - 22:00</li>
                <li>Sobota: 12:00 - 23:00</li>
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-sm mb-4 md:mb-0">
                © {currentYear} Ramen House. Wszelkie prawa zastrzeżone.
              </div>
